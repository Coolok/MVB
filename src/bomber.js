var Bomber = cc.Class.extend({
    ...
    ctor:function (spriteSheet, space, pos) {
        ...
        this.bomberAction = new cc.RepeatForever(new cc.Animate(animation));
        this.bomberAction.retain();	

		
		

		
		 this.sprite = new cc.PhysicsSprite("#bomber00.png");
        ...
        //this.sprite.runAction(this.runSearch);
			...
			sh.setCollisionType(SpriteTag.bomber);
        ...
        this.sprite.runAction(this.bomberAction);
