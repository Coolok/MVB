var White = cc.Class.extend({
    ...
    ctor:function (spriteSheet, space, pos) {
        ...
        this.whiteAction = new cc.RepeatForever(new cc.Animate(animation));
        this.whiteAction.retain();	


		var boxOffset = cp.v(0, 0);
		 this.sprite = new cc.PhysicsSprite("#white00.png");
			var mass1 = 1;
			...
			this.shape.setCollisionType(SpriteTag.white);
        ...
        this.sprite.runAction(this.whiteAction);
