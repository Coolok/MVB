var Pink = cc.Class.extend({
    ...
    ctor:function (spriteSheet, space, pos) {
        ...
        this.pinkAction = new cc.RepeatForever(new cc.Animate(animation));
        this.pinkAction.retain();	


		var boxOffset = cp.v(0, 0);
		 this.sprite = new cc.PhysicsSprite("#pink00.png");
			var mass1 = .5;
			...
			this.shape.setCollisionType(SpriteTag.pink);
		...
		this.space.addConstraint(new cp.DampedSpring(this.body, body2, cp.v(0,0), cp.v(0,-20), 10, 5, 0.003));//body+body++speed+
        ...
        this.sprite.runAction(this.pinkAction);
