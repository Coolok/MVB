var Eagle = cc.Class.extend({
    ...
    ctor:function (spriteSheet, space, pos) {
        ...
        this.eagleAction = new cc.RepeatForever(new cc.Animate(animation));
        this.eagleAction.retain();	


		var boxOffset = cp.v(0, 0);
		 this.sprite = new cc.PhysicsSprite("#eagle00.png");
			var mass1 = .1;
			...
			this.shape.setCollisionType(SpriteTag.eagle);
		...
		//this.space.addConstraint(new cp.SimpleMotor(this.body, body2, Math.PI));
		this.space.addConstraint(new cp.RatchetJoint(this.body, body2, 0, Math.PI/2));
		
		this.space.addConstraint(new cp.DampedSpring(this.body, body2, cp.v(0,0), cp.v(110,10), 1, 4, 0.003));//body+body+?+speed+broke_arrow
        ...
        this.sprite.runAction(this.eagleAction);
