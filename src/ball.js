var Ball = cc.Class.extend({
    ...
    ctor:function (spriteSheet, space, pos) {
        ...
        this.ballAction = new cc.RepeatForever(new cc.Animate(animation));
        this.ballAction.retain();	

		
		

		
		 this.sprite = new cc.PhysicsSprite("#ball00.png");
        ...
        //this.sprite.runAction(this.runSearch);
			...
			sh.setCollisionType(SpriteTag.ball);
        ...
        this.sprite.runAction(this.ballAction);
