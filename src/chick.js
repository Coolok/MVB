var Chick = cc.Class.extend({
    ...
    ctor:function (spriteSheet, space, pos) {
        ...
        this.chickAction = new cc.RepeatForever(new cc.Animate(animation));
        this.chickAction.retain();	


		var boxOffset = cp.v(0, 0);
		 this.sprite = new cc.PhysicsSprite("#chick00.png");
			var mass1 = .2;
			...
			this.shape.setCollisionType(SpriteTag.chick);
			this.shape.setElasticity(0.1);
			this.shape.setFriction(0.7);		

		var radius2 = contentSize.width/2;
			var mass2 = 2;
			var body2 = new cp.Body(mass2, cp.momentForCircle(mass2, 10, radius2, cp.v(0,0)))
		...
		this.space.addConstraint(new cp.DampedSpring(this.body, body2, cp.v(0,0), cp.v(210,40), 1, 4, 0.003));//body+body+?+speed+broke_arrow
        ...
        this.sprite.runAction(this.chickAction);
